                ...
                <div className="mt-4 text-sm">
                  ...
                  {product.images.length > 0 && (
                    ...
                    <div className="flex justify-between mt-4 gap-2 flex-wrap">
                      <button className="bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600" onClick={(e) => {e.stopPropagation();
                        handleEditProduct(product);}}>Editar</button>
                      <button className="bg-red-500 text-white px-4 py-2 rounded-full hover:bg-red-600" onClick={(e) => { e.stopPropagation();
                        handleDeleteProduct(product);}}>Eliminar</button>
                      <button className="bg-green-500 text-white px-4 py-2 rounded-full hover:bg-green-600" onClick={(e) => { e.stopPropagation();
                        handleRegisterMovement(product);}}>Registrar Movimiento</button>
                    </div>
